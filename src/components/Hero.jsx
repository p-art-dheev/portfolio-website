      ...
      >
        ...
        >
          <div className="flex-1 w-full md:w-auto">
            ...
            {/* I'm + Name */}
            <h1 className="flex flex-wrap md:flex-nowrap items-baseline leading-tight mb-3 font-display" style={{ letterSpacing: '-0.02em' }}>
              <span className="text-lg sm:text-xl md:text-2xl lg:text-2xl font-bold theme-greeting mr-2 opacity-80 whitespace-nowrap">I'm</span>
              <span className="text-2xl sm:text-3xl md:text-3xl lg:text-4xl xl:text-4xl font-extrabold theme-name whitespace-nowrap">{config.personal.name}</span>
            </h1>
